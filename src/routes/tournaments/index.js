...
const Tournaments = () => (
	<div>
		...
		<Routes>
			<Upcomming path="/tournaments/upcomming" title="Upcomming" default />
			<OnGoing path="/tournaments/ongoing" title="On Going" />
			<Results path="/tournaments/results" title="Results" />
			<Fixture path="/tournaments/:tournament/fixture" title="Fixture" hideNav />
		</Routes>
